...
The main idea of the algorithm is to build polynomials from two arguments (coords x and y - circle center) which move red and blue channels (of the testing image)
